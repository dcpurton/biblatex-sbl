...
\section{Publisher Locations (5 December 2025)}
...
\examplecite(1){hamori+stokl:2018}
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2025/12/05/publisher-locations/}

\subsection{Notes}

This change renders the majority of prior examples on the blog and in the
handbook incorrect. The \pkg{biblatex-sbl} documentation and example files
now omit the location for all examples as required.
...
@periodical{AJSL,
  title = {American Journal of Semitic Languages and Literature},
  shorttitle = {AJSL}
}

@periodical{atlantis,
  title = {Atlantis: Journal of the Spanish Association of Anglo-American Studies},
  shorttitle = {Atlantis}
}
...
@misc{barbour:seealso,
  author = {Barbour, Jennie},
  title = {\biblstring{seealso} \mkbibemph{Grillo, Jennie}},
  sorttitle = {zzz}
}

@misc{grillo:seealso,
  author = {Grillo, Jennie},
  title = {\biblstring{seealso} \mkbibemph{Barbour, Jennie}},
  sortyear = {zzz}
}
...
\begin{verbcite}
  ...
  \parencite[(\pnfmt{I. 195-200} \mkbibbrackets{O'Neil in Betz})]{PGM:betz}
\end{verbcite}
...
handbook (as in the case of the \citetitle*{treu} above).
...
@mvbook{NTApoc,
  ...
  volumes = {2},
  editora = {Wilson, Robert McL.},
  editorastring = {Rev.\@ ed.\@ English trans.\@ ed.\isdot},
  location = {Cambridge and Louisville},
  publisher = {Clarke and Westminster John Knox},
  date = {2003}
}
...
\examplecite[][pericope]{webster11}
\examplecite[][pericope]{oxford2}
\examplecite[][pericope]{OED2}
\exampleabbreviations
\examplereferences{https://sblhs2.com/2017/05/16/citing-reference-works-8-english-language-dictionaries/}
...
\begin{itemize}
  \item It is assumed that the italicised \emph{YCS} in the blog is an error
    since Yale Classical Studies is a series, not a journal.
\end{itemize}
...
@book{zerwick:2011,
  ...
  origlanguage = {from the 4th Latin ed.},
...
@mvbook{GKB,
  ...
  date = {1918/1929},
  pagination = {section},
  options = {shorthandformat=roman, partsinvols},
  langid = {german}
}
...
\pkg{biblatex} does not cope well with malformed dates, so use
\verb+date = {1995/2004}+ for \cite{HAL} which is standard.
...
@book{gibson,
  ...
  title = {Libanius's Progymnasmata: Model Exercises in Greek Prose Composition and
           Rhetoric},
...
@book{hendel:2016,
  ...
  title = {Steps to a New Edition of the Hebrew Bible},
...
@inbook{hendel:2016:ch3,
  title = {The Idea of a Critical Edition of the Hebrew Bible: A Genealogy},
  crossref = {hendel:2016},
  pages = {65-100}
}

@article{mckenzie:2010,
  author = {McKenzie, Steven L.},
  title = {Elaborated Evidence for the Priority of 1~Samuel 26},
  journaltitle = {Journal of Biblical Literature},
  shortjournal = {JBL},
  volume = {129},
  date = {2010},
...
@online{sblhsblog:formattingtitles,
  entrysubtype = {blog},
  title = {Formatting Titles},
  website = {SBL Handbook of Style},
  date = {2016-10-27},
  url = {https://sblhs2.com/2016/10/27/formatting-titles/}
}

@incollection{aymer:2016,
  author = {Aymer, Margaret},
  title = {Outrageous, Audacious, Courageous, Willful: Reading the Enslaved Girl of
           Acts 12},
  crossref = {byron+lovelace:2016},
  pages = {265-292}
}

@incollection{byron+lovelace:2016:part3,
  author = {Byron, Gay L. and Lovelace, Vanessa},
  authortype = {editor},
  title = {Foregrounding Women on the Margins},
  crossref = {byron+lovelace:2016},
  pages = {187-264},
  options = {noinherit=names}
}

@unpublished{yee:2015,
  author = {Yee, Gale A.},
  title = {\mkbibquote{He Will Take the Best of Your Fields}: Royal Feasts and Rural
           Extraction},
  type = {paper},
  eventtitle = {the the 2015 Annual Meeting of the Society of Biblical Literature},
  venue = {Atlanta},
  eventdate = {2015-11-22}
}

@thesis{ames:1998,
  author = {Ames, Frank Ritchel},
  title = {Women and War in the Hebrew Bible},
  type = {phdthesis},
  institution = {The Iliff School of Theology and The University of Denver},
  date = {1998}
}

@ancienttext{enumaelish,
  title = {Enuma Elish},
  xref = {ANET},
  pages = {60-72}
}

@online{perseusdigitallibrary,
...
\end{verbcite}
\begin{verbcite}
  \citeauthor{scorsese:aviator}'s \citetitle*{scorsese:aviator}
\end{verbcite}
\begin{verbcite}
  \citefield{sblhsblog:formattingtitles}[website]{website} blog
\end{verbcite}
\begin{verbcite}
...
\end{verbcite}
\begin{verbcite}
  \citeauthor{yee:2015}'s paper \citetitle*{yee:2015}
\end{verbcite}
\begin{verbcite}
  \citeauthor{ames:1998}'s \citetitle*{ames:1998}
\end{verbcite}
\begin{verbcite}
  the blog post \citetitle*{sblhsblog:formattingtitles} on the
  \citefield{sblhsblog:formattingtitles}[website]{website} blog
\end{verbcite}
\begin{verbcite}
  \citeseries*{byron+lovelace:2016}
\end{verbcite}
\begin{verbcite}
  \citetitle*{enumaelish}
\end{verbcite}
\begin{verbcite}
  the \citefield{perseusdigitallibrary}[website]{website}
\end{verbcite}
\exampleancientsources
\examplesecondarysources
\examplebibliography
...
\end{fverbcite}
\begin{verbtext}
  \footnote{This is in line with \citeshortauthor{desilva:1998}’s treatment of
  Rev 2–3 as part of the text’s use of honor discourse
  \autocite{desilva:1998}.}
\end{verbtext}
\quad 77.\space\strut This is in line with \citeshortauthor{desilva:1998}’s
treatment of Rev 2–3 as part of the text’s use of honor discourse.
\cite[See][]{desilva:1998}.
...
\examplecite[paren][(2.2)]{livy:aburbe}
\examplecite[ptrans][(2.2)]{livy:aburbe}
\exampleabbreviations
...
\examplecite[paren][(1.2)]{diocassius:histrom}
\examplecite[][(1.2.3)]{diocassius:histrom}
\examplecite[ptrans][(1.2)]{diocassius:histrom}
\exampleabbreviations
\examplereferences{https://sblhs2.com/2016/09/01/dio-cassius/}
...
\begin{verbcite}
  ...
  \citetitle{bailey+liew+segovia:2009}, which was edited by
...
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/08/30/titles-question-marks/}
...
\examplecite[paren][(2.2)]{thucydides:pw}
\examplecite[][(2.2.4)]{thucydides:pw}
\examplecite[ptrans][(2.2)]{thucydides:pw}
\exampleabbreviations

\subsection{Notes}

SBL tends to have a preference to use Latin titles for ancient works rather
than English ones. In keeping with this, I have use \citetitle*{thucydides:pw}
...
\examplereferences{https://sblhs2.com/2016/08/11/thucydides/}
...
\examplereferences{https://sblhs2.com/2016/08/09/hts-teologiese-studies/}
...
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/08/04/la-bible-dalexandrie-septuaginta/}
...
\examplereferences{https://sblhs2.com/2016/07/19/reallexikon-assyriologie/}
...
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/07/07/ots-otst/}
...
\examplecite[][25 \mkbibparens{22, r.2--8}]{dietrich:2003}
\examplevolcite[]{17}[25, 22.r.6--8]{SAA}
\examplevolcite[]{2}[13, 2.vi.3-4]{SAA}
\examplevolcite[]{18}[70-71, text~87]{SAA}
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/06/23/state-archives-of-assyria/}
...
\examplevolcite[]{17.1}[299-301]{CAD}
\exampleabbreviations
\examplereferences{https://sblhs2.com/2016/06/16/chicago-assyrian-dictionary/}
...
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/06/14/semeia-semeia-studies/}
...
\end{verbcite}
\exampleancientsources
\examplereferences{https://sblhs2.com/2016/06/07/hippolytus-or-hippolytus-rome/}
...
\exampleabbreviations
\examplebibliography
\examplereferences{https://sblhs2.com/2016/06/02/first-last-name-order/}
\end{document}
