...
\examplecite(17)[\sv~\mkbibquote{Onycha}]{HBD}
\examplevolcite(18){1}[\sv~\mkbibquote{Baladan}]{NIDB}
\examplecite(12)[\svv~\mkbibquote{Alamoth,} \mkbibquote{Sheminith}]{HBD}
\begin{fverbcite}{38}
  \avolcites{1}[\sv~\mkbibquote{Baladan}]{NIDB}{4}[\sv~\mkbibquote{Menna}]{NIDB}
\end{fverbcite}
...
\examplevolcite(71){1}[\sv~\mkbibquote{Baal \mkbibparens{Place}}]{ABD}
...
\examplecite(25)[\sv~\mkbibquote{Abilene}]{EDB}
\examplecite(26)[3]{dever:abel}
\examplecite(40){stone:isaactest}
\examplecite(18)[\sv~\mkbibquote{Honey}]{HBD}
\examplecite(80){schaub:holywar}
\examplecite(54)[510]{popelevison:truth}
\examplevolcite(22){1}[\sv~\mkbibquote{Ara}]{IDB}
\examplecite(27){dentan:apple}
\examplecite(32)[\sv~\mkbibquote{Hillel}]{IDBSup}
\examplecite(14)[608]{sperling:mount}
\examplevolcite(37){4}[\sv~\mkbibquote{Sosipater}]{ISBE}
...
\examplevolcite(5){1}[\sv~\mkbibquote{Baladan}]{NIDB}
\examplecite(72)[215]{graf:arab}
\examplecite(16)[1227]{taylor:protogoras}
\examplecite(57)[\sv~\mkbibquote{Mendicant Friars}]{ODCC}
