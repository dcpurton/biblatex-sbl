...
\begin{fverbcite}{42}
  ...
  accepted their plea to [forgive] their rebellion (lit.\@ ‘sin’) and s[pared]
  their land” \pvoltranscite{2.117E}[290,
...
\end{verbcite}
\begin{fverbcite}{15}
  \footnote{The testament goes on to say, “Do not devote your attention to the beauty of
  women, my children, nor occupy your minds with their activities”
...
\begin{fverbcite}{17}
  \footnote{For the account of Levi attempting to save Pharaoh’s son,
  see \cite[(29.1-6)]{jos.asen.}.}
\end{fverbcite}
\exampleancientsources
\examplesecondarysources
