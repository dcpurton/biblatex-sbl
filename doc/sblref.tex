...
\noindent The following examples define SBL style for notes and bibliographies
more fully than the select rules in §6 of the second edition of the SBL
Handbook of Style.

\noindent Note that the bib database entries shown below make extensive use of
...
\noindent TODO: Related entries not yet supported.
...
\noindent TODO: Not yet supported.
...
\subsubsection{J.--P. Migne's Patrologia latin and Patrologia graeca}
...
\noindent TODO: Note yet supported.
