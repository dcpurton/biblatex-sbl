...
\lstdefinelanguage{BibTeX}{%
  keywords={%
    ...
    @reference,@mvcollection,@bookinbook,@ancienttext,@classictext%
  },
  emph={%
    ...
    eventtitle,releasedate,origtranslator,volumes,shortmaintitle,options,%
    editortype,crossref,editora,editorb,editorc,editoratype,editorbtyle,%
    editorctype,entrysubtype,sortkey,titleaddon%
  },
  sensitive=false,
}
...
{\color{biblatex-colour}
 ...
 \hangindent\bibindent\bibentrycite{stendahl:1962}.\par}
...
\citetestnpbib{7}{11}{greathymnaten}{hallo:1997}
...
\citetestnsnpbib{5}{erraandishum:foster}{foster:1993}
...
\citetestnpfbib{34}{36}{200-203}{doomedprince}{lichtheim:1976}
...
{\textsc{BibLaTeX Output}\par
  ...
  \color{biblatex-colour}
\hangindent\bibindent\bibentrycite{josephus}.\par
\hangindent\bibindent\bibentrycite{tacitus}.\par}
...
{\textsc{BibLaTeX Output}\par
  \nobreak
  \texttt{\textbackslash parencite[III. 1-164]\{PGM\}}\par
  \color{biblatex-colour}
  \parencite[III. 1-164]{PGM}.\par
  \color{black}
  \texttt{\textbackslash autocite[III. 1-164]\{PGM\}}\par
  \color{biblatex-colour}
22. \cite[III. 1-164]{PGM}.\par}
...
\citetestnsbib{22}{III. 1-164|}{PGM:betz}{betz:1996}

\begin{refimp}
  22. PGM III. 1–164 (Betz).
...
{\textsc{BibLaTeX Output}\par
  ...
  \texttt{\textbackslash printbibliography}\par
  \color{biblatex-colour}
  \hangindent\bibindent\bibentrycite{heraclitus:epistle1:worley:1977}.\par
\hangindent\bibindent\bibentrycite{malherbe:1977}}
...
{\textsc{BibLaTeX Output}\par
  ...
  \texttt{\textbackslash printbibliography}\par
  \color{biblatex-colour}
  \hangindent\bibindent\bibentrycite{PL}.\par
\hangindent\bibindent\bibentrycite{PG}\par}
...
\subsubsection{\emph{Aufsteig und Niedergang der römischen Welt (ANRW)}}
...
{\textsc{BibLaTeX Output}\par
  ...
  \texttt{\textbackslash printbibliography}\par
  \color{biblatex-colour}
  \sloppy\hangindent\bibindent\bibentrycite{anderson:pepaideumenos}.\par
\hangindent\bibindent\bibentrycite{ANRW}\par}
