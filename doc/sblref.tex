...
\begin{refimp}
  ...
  of New Testament Theology.} 4~vols. Grand Rapids: Zondervan,
  1975–1985.\footnote{Should be “1975–1978.”?}
\end{refimp}
...
\subsection{BDAG, BDB, BDF, \emph{HALOT}}
...
{\textsc{BibLaTeX Output}\par
\nobreak
\texttt{\textbackslash autocite[432]\{BDB\}}\par
\color{biblatex-colour}
2. \cite[432]{BDB}.\par
\color{black}
\texttt{\textbackslash printbibliography}\par
\color{biblatex-colour}
\hangindent\bibindent\bibentrycite{BDB:1906}.\par}
