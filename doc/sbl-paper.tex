...
\ifxetexorluatex
  ...
  \babelfont[hebrew]{rm}[Ligatures=TeX,Contextuals=Alternate]{SBL BibLit}
...
\makeindex[name=\jobname-scr,title=Scripture Reference Index,intoc,options=-s
sbl-paper-bibleref.ist -q]
