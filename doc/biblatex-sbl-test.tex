...
\lstdefinelanguage{BibTeX}{%
  ...
  emph={%
    ...
    note,releasedate,volumes,shortmaintitle,options,eprintclass,%
...
\begin{refimp}
  ...
  Setting,} ed. Bruce W. Winter and Andrew D. Clarke, vol.~1 of \emph{The Book
  of Acts in Its First Century Setting,} ed. Bruce W. Winter (Grand Rapids:
  Eerdmans, 1993), 83–104.
...
\begin{refimp}
  ...
  Biblical Interpretation,} trans. Leo G. Perdue (Atlanta: Society of Biblical
...
\begin{refimp}
  ...
  Noel Freedman. \emph{New York Times Review of Books,} 20 December 1992, 3.
...
\begin{biboutput}
  ...
  \samplemacro{\textbackslash usepackage[style=sbl,fullbibrefs=true]\{biblatex\} \\
...
\begin{refimp}
  \hspace*{\bibindent}6. Hermann W. Beyer, “\gr{διακονέω, διακονία, κτλ},”
  \emph{TDNT} 2:81–93.
...
\begin{refimp}
  \hspace*{\bibindent}7. Ceslas Spicq, “\gr{ἀτακτέω, ἄτακτος, ἀτάκτως},”
  \emph{TLNT} 1:223–24.
...
\begin{refimp}
  \hspace*{\bibindent}23. Hermann W. Beyer, “\gr{διακονέω},” \emph{TDNT}
  2:81–87.
...
\begin{refimp}
  \hspace*{\bibindent}26. Karl Dahn, “\gr{ὁράω},” \emph{NIDNTT} 3:511–18.
...
\begin{biboutput}
  ...
  \samplebib{RIMA}
  \samplebiblist{shortseries-RIMA}
\end{biboutput}
...
\begin{biboutput}
  ...
  \samplebib{ARM1}
  \samplebiblist{shortseries-ARM1}
\end{biboutput}
...
\begin{biboutput}
  ...
  \samplebib{ARMT1}
  \samplebiblist{shortseries-ARMT1}
\end{biboutput}
...
\begin{refimp}
  ...
  Books 1–19,} trans.\ Henry St.\ J. Thackeray et al., LCL (Cambridge: Harvard
...
\begin{biboutput}
  ...
  \samplebib{ANF:Roberts+Donaldson}
  \samplebiblist{ANF}
\end{biboutput}
...
\begin{biboutput}
  ...
  \samplecite*{3}[See the discussion of \gr{ἐκρατοῦντο} in][2:271]{Str-B}
  \samplebib{Str-B}
  \samplebiblist{Str-B}
\end{biboutput}

\begin{refimp}
  \hspace*{\bibindent}3. See the discussion of \gr{ἐκρατοῦντο} in Str-B 2:271.
