...
\usepackage{hyperref}
\usepackage{makeidx}
\usepackage[style=sbl,indexing,ibidtracker,pagetracker,backend=biber]{biblatex}
...
\begin{biboutput}
  \samplemacro{\textbackslash usepackage[style=sbl,ibidtracker,backend=biber]\{biblatex\}}
...
\begin{biboutput}
  \samplemacro{\textbackslash usepackage[style=sbl,ibidtracker,pagetracker,backend=biber]\{biblatex\}}
...
\begin{biboutput}
  \samplemacro{\textbackslash usepackage[style=sbl,ibidtracker,ibidpage,backend=biber]\{biblatex\}}
