...
\usepackage{hyperref}
\usepackage[style=sbl,indexing=cite,ibidtracker=constrict,idemtracker=constrict]{biblatex}
...
\begin{biboutput}
  \samplemacro{\textbackslash usepackage[style=sbl,idemtracker=constrict]\{biblatex\}}
