...
\usepackage[style=sbl,indexing,backend=biber]{biblatex}
...
Society of Biblical Literature (\citeseries{SBL}). The style conforms to the
second edition of the \cite{SBLHS}.
...
\biblatexsbl defaults to the recommendations of the \citeseries{SBL}, but it
also supports many of the standard options from \biblatex as well as a few
...
may lead to ambiguous citations. If you you prefer the wider interpretation of
