...
A multi-volume series. \biblatexsbl treats this as an alias for
\bibtype{mvbook} except that an upright shaped font is used for the
\bibfield{title} field and the \bibfield{option} field is set to
\bibfield{\{useauthor=false,} \bibfield{useditor=false\}} by default.
