...
\begin{function}{\printbiblist}
  \begin{syntax}
    \oarg{key=value, ...}\marg{abbreviations}
  \end{syntax}
...
\begin{function}{\sv, \svv}
  These commands insert the bib strings |subverbo| and |subverbis| (sv.\ and
  svv.\ by default) into a \meta{postnote}.
\end{function}
...
This section documents localisation strings that have been added or customised
for \pkg{biblatex-sbl}.
...
\begin{function}{byeditortr}
\end{function}

\begin{function}{byeditor}
\end{function}

\begin{function}{byreviser}
\end{function}

\begin{function}{bytranslator}
\end{function}
...
\begin{function}{editors}
\end{function}

\begin{function}{editortr}
\end{function}

\begin{function}{editorstr}
\end{function}
...
\begin{function}{translator}
\end{function}

\begin{function}{translators}
\end{function}
